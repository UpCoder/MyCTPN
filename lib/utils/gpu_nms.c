...
static char __pyx_k_lib_utils_gpu_nms[] = "lib.utils.gpu_nms";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_home_give_Game_OCR_Papers_code[] = "/home/give/Game/OCR/Papers-code/text-detection-ctpn-master/lib/utils/gpu_nms.pyx";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "lib.utils.gpu_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "lib.utils.gpu_nms", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int boxes_num = dets.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3lib_5utils_7gpu_nms_1gpu_nms, NULL, __pyx_n_s_lib_utils_gpu_nms); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
